...
# compare infant mortality in South Korea and Poland
gapminder %>%
  filter(year == 2015 & country %in% c("South Korea", "Poland")) %>%
  select(country, infant_mortality)

# compare infant mortality in Malaysia and Russia
gapminder %>%
  filter(year == 2015 & country %in% c("Malaysia", "Russia")) %>%
  select(country, infant_mortality)

# compare infant mortality in Pakistan and Vietnam
gapminder %>%
  filter(year == 2015 & country %in% c("Pakistan", "Vietnam")) %>%
  select(country, infant_mortality)

# compare infant mortality in Thailand and South Africa
gapminder %>%
  filter(year == 2015 & country %in% c("Thailand", "South Africa")) %>%
  select(country, infant_mortality)

# compare infant mortality in India and China
gapminder %>%
  filter(year == 2015 & country %in% c("India", "China")) %>%
  select(country, infant_mortality)
